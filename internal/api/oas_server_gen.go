...
type Handler interface {
	...
	// EventsEventsStream implements Events_eventsStream operation.
	//
	...
	//
	// GET /events/stream
	EventsEventsStream(ctx context.Context, params EventsEventsStreamParams) (*EventsEventsStreamOKHeaders, error)
	...
	// UsersImportChannel implements Users_importChannel operation.
	//
	// Import files from a Telegram channel into TelDrive.
	//
	// POST /users/channels/{id}/import
	UsersImportChannel(ctx context.Context, req *ChannelImport, params UsersImportChannelParams) (*ImportResult, error)
