...
type Channel struct {
	...
	// Whether this channel is the currently selected storage channel.
...
func (s *Channel) GetSelected() OptBool {
	return s.Selected
}
...
func (s *Channel) SetSelected(val OptBool) {
	s.Selected = val
}

// Request body for importing files from a Telegram channel.
// Ref: #/components/schemas/ChannelImport
type ChannelImport struct {
	// Destination path in TelDrive where imported files will be placed.
	Path OptString `json:"path"`
}

// GetPath returns the value of Path.
func (s *ChannelImport) GetPath() OptString {
	return s.Path
}

// SetPath sets the value of Path.
func (s *ChannelImport) SetPath(val OptString) {
	s.Path = val
}
...
type EventsEventsStreamOK struct {
	Data io.Reader
}
...
func (s EventsEventsStreamOK) Read(p []byte) (n int, err error) {
	if s.Data == nil {
		return 0, io.EOF
	}
...
type EventsEventsStreamOKCacheControl string

const (
	EventsEventsStreamOKCacheControlNoCache EventsEventsStreamOKCacheControl = "no-cache"
)

// AllValues returns all EventsEventsStreamOKCacheControl values.
func (EventsEventsStreamOKCacheControl) AllValues() []EventsEventsStreamOKCacheControl {
	return []EventsEventsStreamOKCacheControl{
		EventsEventsStreamOKCacheControlNoCache,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s EventsEventsStreamOKCacheControl) MarshalText() ([]byte, error) {
	switch s {
	case EventsEventsStreamOKCacheControlNoCache:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *EventsEventsStreamOKCacheControl) UnmarshalText(data []byte) error {
	switch EventsEventsStreamOKCacheControl(data) {
	case EventsEventsStreamOKCacheControlNoCache:
		*s = EventsEventsStreamOKCacheControlNoCache
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
...
type EventsEventsStreamOKConnection string

const (
	EventsEventsStreamOKConnectionKeepAlive EventsEventsStreamOKConnection = "keep-alive"
)

// AllValues returns all EventsEventsStreamOKConnection values.
func (EventsEventsStreamOKConnection) AllValues() []EventsEventsStreamOKConnection {
	return []EventsEventsStreamOKConnection{
		EventsEventsStreamOKConnectionKeepAlive,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s EventsEventsStreamOKConnection) MarshalText() ([]byte, error) {
	switch s {
	case EventsEventsStreamOKConnectionKeepAlive:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *EventsEventsStreamOKConnection) UnmarshalText(data []byte) error {
	switch EventsEventsStreamOKConnection(data) {
	case EventsEventsStreamOKConnectionKeepAlive:
		*s = EventsEventsStreamOKConnectionKeepAlive
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
...
// EventsEventsStreamOKHeaders wraps EventsEventsStreamOK with response headers.
type EventsEventsStreamOKHeaders struct {
	CacheControl EventsEventsStreamOKCacheControl
	Connection   EventsEventsStreamOKConnection
	Response     EventsEventsStreamOK
}

// GetCacheControl returns the value of CacheControl.
func (s *EventsEventsStreamOKHeaders) GetCacheControl() EventsEventsStreamOKCacheControl {
	return s.CacheControl
}

// GetConnection returns the value of Connection.
func (s *EventsEventsStreamOKHeaders) GetConnection() EventsEventsStreamOKConnection {
	return s.Connection
}

// GetResponse returns the value of Response.
func (s *EventsEventsStreamOKHeaders) GetResponse() EventsEventsStreamOK {
	return s.Response
}

// SetCacheControl sets the value of CacheControl.
func (s *EventsEventsStreamOKHeaders) SetCacheControl(val EventsEventsStreamOKCacheControl) {
	s.CacheControl = val
}

// SetConnection sets the value of Connection.
func (s *EventsEventsStreamOKHeaders) SetConnection(val EventsEventsStreamOKConnection) {
	s.Connection = val
}

// SetResponse sets the value of Response.
func (s *EventsEventsStreamOKHeaders) SetResponse(val EventsEventsStreamOK) {
	s.Response = val
}
...
type File struct {
	...
	// Upload session ID (for multi-part uploads).
	...
	// BLAKE3 tree hash for integrity checking.
...
func (s *File) GetUploadId() OptString {
	return s.UploadId
}
...
func (s *File) SetUploadId(val OptString) {
	s.UploadId = val
}
...
func (s *File) SetHash(val OptString) {
	s.Hash = val
}
...
type FileUpdate struct {
	...
	// Channel ID.
	ChannelId OptInt64 `json:"channelId"`
	// Upload ID for hash calculation.
	UploadId OptString `json:"uploadId"`
	// File parts.
	Parts []Part `json:"parts"`
...
// GetParentId returns the value of ParentId.
func (s *FileUpdate) GetParentId() OptString {
	return s.ParentId
}

// GetChannelId returns the value of ChannelId.
func (s *FileUpdate) GetChannelId() OptInt64 {
	return s.ChannelId
}

// GetUploadId returns the value of UploadId.
func (s *FileUpdate) GetUploadId() OptString {
	return s.UploadId
}
...
// GetEncrypted returns the value of Encrypted.
func (s *FileUpdate) GetEncrypted() OptBool {
	return s.Encrypted
}
...
// SetParentId sets the value of ParentId.
func (s *FileUpdate) SetParentId(val OptString) {
	s.ParentId = val
}

// SetChannelId sets the value of ChannelId.
func (s *FileUpdate) SetChannelId(val OptInt64) {
	s.ChannelId = val
}

// SetUploadId sets the value of UploadId.
func (s *FileUpdate) SetUploadId(val OptString) {
	s.UploadId = val
}
...
// SetEncrypted sets the value of Encrypted.
func (s *FileUpdate) SetEncrypted(val OptBool) {
	s.Encrypted = val
}
...
type ImportResult struct {
	// Number of files newly imported.
	Imported int `json:"imported"`
	// Total number of file messages scanned in the channel.
	Total int `json:"total"`
}

// GetImported returns the value of Imported.
func (s *ImportResult) GetImported() int {
	return s.Imported
}

// GetTotal returns the value of Total.
func (s *ImportResult) GetTotal() int {
	return s.Total
}

// SetImported sets the value of Imported.
func (s *ImportResult) SetImported(val int) {
	s.Imported = val
}

// SetTotal sets the value of Total.
func (s *ImportResult) SetTotal(val int) {
	s.Total = val
}
...
type Source struct {
	...
	// Full path of the file/folder (e.g., 'documents/projects/file.txt').
	Path OptString `json:"path"`
}
...
// GetPath returns the value of Path.
func (s *Source) GetPath() OptString {
	return s.Path
}
...
// SetPath sets the value of Path.
func (s *Source) SetPath(val OptString) {
	s.Path = val
}
