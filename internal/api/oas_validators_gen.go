...
func (s EventsEventsStreamOKCacheControl) Validate() error {
	switch s {
	case "no-cache":
		return nil
	default:
...
func (s EventsEventsStreamOKConnection) Validate() error {
	switch s {
	case "keep-alive":
		return nil
	default:
...
func (s *EventsEventsStreamOKHeaders) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
