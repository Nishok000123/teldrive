			...
			case 'e': // Prefix: "events"
				...
				case '/': // Prefix: "/stream"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "GET":
							s.handleEventsEventsStreamRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, "GET")
						}
							...
							case '/': // Prefix: "/"
								...
								case '/': // Prefix: "/import"
									...
									if len(elem) == 0 {
										...
										switch r.Method {
										case "POST":
											s.handleUsersImportChannelRequest([1]string{
												args[0],
											}, elemIsEscaped, w, r)
										default:
											s.notAllowed(w, r, "POST")
			...
			case 'e': // Prefix: "events"
				...
				case '/': // Prefix: "/stream"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "GET":
							r.name = EventsEventsStreamOperation
							r.summary = "Server-Sent Events stream"
							r.operationID = "Events_eventsStream"
							r.operationGroup = ""
							...
							case '/': // Prefix: "/"
								...
								case '/': // Prefix: "/import"
									...
									if len(elem) == 0 {
										...
										switch method {
										case "POST":
											r.name = UsersImportChannelOperation
											r.summary = "Import files from a Telegram channel into TelDrive"
											r.operationID = "Users_importChannel"
											r.operationGroup = ""
											r.pathPattern = "/users/channels/{id}/import"
											r.args = args
											r.count = 1
											return r, true
										default:
